...
public class LeetCodeImplTest {
    ...
    public void searchInsertPosition() {
        ...
        assertEquals(2, service.searchInsertPosition(nums, 5));
        assertEquals(1, service.searchInsertPosition(nums, 2));
        assertEquals(4, service.searchInsertPosition(nums, 7));
		assertEquals(0, service.searchInsertPosition(nums, 0));
